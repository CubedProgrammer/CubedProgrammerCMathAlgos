...
#define cpcma_todeg(n)((n) / 3.141592653589793 * 180)
#define cpcma_torad(n)((n) * 3.141592653589793 / 180)
#define sindeg(n)sin(cpcma_torad(n))
#define cosdeg(n)cos(cpcma_torad(n))
#define tandeg(n)tan(cpcma_torad(n))
#define cpcma_versindeg(n)cpcma_versin(cpcma_torad(n))
#define cpcma_vercosdeg(n)cpcma_vercos(cpcma_torad(n))
#define cpcma_coversindeg(n)cpcma_coversin(cpcma_torad(n))
#define cpcma_covercosdeg(n)cpcma_covercos(cpcma_torad(n))
#define asindeg(n)cpcma_todeg(asin(n))
#define acosdeg(n)cpcma_todeg(acos(n))
#define atandeg(n)cpcma_todeg(atan(n))
#define sinfdeg(n)sinf(cpcma_torad(n))
#define cosfdeg(n)cosf(cpcma_torad(n))
#define tanfdeg(n)tanf(cpcma_torad(n))
#define cpcma_versinfdeg(n)cpcma_versinf(cpcma_torad(n))
#define cpcma_vercosfdeg(n)cpcma_vercosf(cpcma_torad(n))
#define cpcma_coversinfdeg(n)cpcma_coversinf(cpcma_torad(n))
#define cpcma_covercosfdeg(n)cpcma_covercosf(cpcma_torad(n))
#define asinfdeg(n)cpcma_todeg(asinf(n))
#define acosfdeg(n)cpcma_todeg(acosf(n))
#define atanfdeg(n)cpcma_todeg(atanf(n))
